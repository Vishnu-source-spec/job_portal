                ...
                <div class="col-lg-9">
                    ...
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body card-form">
                                        ...
                                        @if ($jobs->isNotEmpty())
                                            @foreach ($jobs as $job )
                                             ...
                                             <tr class="active">
                                                ...
                                                <td>{{\Carbon\Carbon::parse($job->created_at)->format('d M, Y')}}</td> {{--  we use this getting date in specific format  --}}
                            ...
                            {{-- We can only use this link method when we already used paginate in our conroller --}}
                            {{-- then go to app serviceprovider file and do some modification
